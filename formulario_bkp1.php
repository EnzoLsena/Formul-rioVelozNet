...
<head>
    ...
    <title>form-apr-vlz</title>
</head>
<body>
    <header>FORMULÁRIO APR - VLZ TELECOM </header>
    <hr>
    <main>
            ...
            <input type="text" name="atividade" id="iatividade"><br>
               <br>
        ...
        <input type="checkbox" name="PRO" id="iPRO5"value="Improsar consertos em máquinas / equipamentos">
        <label for="iPRO5">Improsar consertos em máquinas / equipamentos </label><br>
    ...
    <br>
        <label for="iassinatura">ASSINATURA DA EQUIPE</label><br>
        <input type="text" name="assinatura" id="iassinatura"><br>
    <br>
